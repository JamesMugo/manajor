  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="admindashboard.php">
        ...
        <div class="sidebar-brand-text mx-3">Manajor Admin<sup>2</sup></div>
      </a>
          ...
          <li class="nav-item">
            ...
            <div id="collapseOwners" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="#ownerpanel">View</a>
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <form class="user" id="editform" style="display: none">
            ...
            <div class="form-group row">
              <div class="col-sm-6">
                <input type="text" class="form-control form-control-user" name="rent" placeholder="Rent" required="required" id="rent">
              </div>
              <div class="col-sm-6">

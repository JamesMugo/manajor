...
if(isset($_POST['submit'])){
  ...
  $query="INSERT INTO owners(firstname, lastname, idNumber, propertyOwned, location, rent, agreement) VALUES ('$firstname','$lastname','$id','$propertyOwned','$location','$rent','$agreement')";
                  ...
                  <div class="col-lg-7">
                    <div class="p-5">
                      ...
                      <form class="user" action="" method="POST">
                        ...
                        <div class="form-group row">
                          <div class="col-sm-6 mb-3 mb-sm-0">
                            <input type="text" class="form-control form-control-user" name="agreement" placeholder="Agreement" required="required">
                          </div>
                        </div>
                        <hr>
